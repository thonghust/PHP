...
<div style="width:1100px; height:1100px; background:#ffc; margin:auto" align="center">
...
<font style="font-family:Tahoma, Geneva, sans-serif; font-size:20px; padding-left:10px; font-weight:bold">Chủ đề:</font>
...
<?php
	...
	echo $num['topic'];
?>
<font style="font-family:Tahoma, Geneva, sans-serif; font-size:15px; padding-left:10px; font-weight:bold; color:#000">(Có <?php echo mysqli_num_rows($q); ?> bài viết)</font>
</font><br>
